...
A plain citation looks like this~\cite{shannon1948}. Several at once collapse
automatically~\cite{kuhn1962,vaswani2017,shannon1937}. \texttt{biblatex} also
offers \verb|\parencite| for a parenthesised form~\parencite{bernerslee1989}
and \verb|\textcite| for one that reads as part of the sentence:
\textcite{darwin1859} makes this point directly.
