...
% 這四張圖的 PDF 已經納入版本控制，所以 Overleaf 上不需要執行任何 Python。
% 換成自己的圖時，把 figures/ 裡的檔案覆蓋掉即可。
% The four PDFs are committed, so Overleaf never runs Python. Swap in your own
% plots by overwriting the files in figures/.
