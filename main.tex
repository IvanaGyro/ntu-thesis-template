...
% Fonts
%
% engfont and cjkfont each take a font file in fonts/english/ and
% fonts/chinese/ respectively, written with its extension, or the name of a font
% family installed on the system (Overleaf's image included). The file is looked
% for first. Neither matching is an error.
%
...
% upright.
%
% Tinos is metrically identical to Times New Roman, which the NTU rules name.
% Write {Times New Roman} with empty options on a machine that has it.
% TW-Sung-98_1.ttf is the shipped 全字庫正宋體, in place of 正楷體.
% --------------------------------------------------
\ntufontsetup{
